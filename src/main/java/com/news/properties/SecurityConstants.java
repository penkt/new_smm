...
public interface SecurityConstants {
     ...
     * 默认的用户名密码登录请求处理url
     */
    String DEFAULT_SIGN_IN_PROCESSING_URL_FORM = "/login_in";

    /**
     * 默认的手机验证码登录请求处理url
     */
    String DEFAULT_SIGN_IN_PROCESSING_URL_REGISTER= "/login_in/userzc";

   /*
     *  /reset-user
    */
    String DEFAULT_SIGN_IN_PROCESSING_URL_RESETUSER="/reset-user ";
    ...
    /**
     * 发送邮箱验证码 或 验证邮箱验证码时，传递邮箱号的参数的名称
     */
